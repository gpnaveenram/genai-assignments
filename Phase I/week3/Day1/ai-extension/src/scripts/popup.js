    ...
    const modelsByProvider = {
      groq: [
        { value: 'llama-3.3-70b-versatile', label: 'llama-3.3-70b-versatile' },
             { value: 'openai/gpt-oss-20b', label: 'openai-small-model' }
   
        ],
      openai: [
           { value: 'ft:gpt-4o-2024-08-06:personal::D1dF7CWg', label: 'fine tuned' },
        { value: 'ft:open-mistral-7b:83a13a2e:20251224:43c7eec0', label: 'ft:open-mistral-7b:83a13a2e:20251224:43c7eec0' },


      ] ,
      testleaf: [
        { value: 'ft:gpt-4o-2024-08-06:qeagle-1::D1QRdvhi', label: 'finetunedmodel' },
        { value: 'testleaf-gpt-3.5-turbo', label: 'Testleaf GPT-3.5 Turbo' },
          { value: 'ft:gpt-4o-mini-2024-07-18:qeagle-1::DDsfzagZ', label: 'ft:gpt-4o-mini-2024-07-18:qeagle-1::DDsfzagZ' },
{ value: 'ft:gpt-4o-mini-2024-07-18:qeagle-1::DEDFKW4y', label: 'Finetuned model' },


        //ft:gpt-4o-mini-2024-07-18:qeagle-1::D7bXRJPX
      ]
    };
