...
class ChatUI {
    ...
    getPromptKeys(language, engine) {
        ...
        if (!isFeatureChecked && !isPageChecked) {
            ...
            if (this.isJavaSelenium(lang, eng)) {
                ...
                promptKeys.push('PLAYWRIGHT_TYPESCRIPT_POM');
            } else if (this.isJavaScriptPlaywright(lang, eng)) {
                promptKeys.push('PLAYWRIGHT_JAVASCRIPT_POM');
            }
            return promptKeys;
        }
        ...
        if (isFeatureChecked && isPageChecked) {
            ...
            if (this.isJavaSelenium(lang, eng)) {
                ...
                promptKeys.push('PLAYWRIGHT_TYPESCRIPT_POM_AND_SPEC');
            } else if (this.isJavaScriptPlaywright(lang, eng)) {
                promptKeys.push('PLAYWRIGHT_JAVASCRIPT_POM_AND_SPEC');
            } else {
                // For non-Java/Selenium and non-Playwright combinations
            ...
            if (this.isTypeScriptPlaywright(lang, eng)) {
                promptKeys.push('PLAYWRIGHT_TYPESCRIPT_SPEC');
            } else if (this.isJavaScriptPlaywright(lang, eng)) {
                promptKeys.push('PLAYWRIGHT_JAVASCRIPT_SPEC');
            } else {
                promptKeys.push('CUCUMBER_ONLY');
            }
    ...
    /**
     * Helper method to check if the combination is JavaScript + Playwright
     */
    isJavaScriptPlaywright(language, engine) {
        return language === 'js' && engine === 'playwright';
    }
